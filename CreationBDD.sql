...
CREATE TABLE IF NOT EXISTS  compte (Matricule INT AUTO_INCREMENT PRIMARY KEY,typePost VARCHAR(50) NOT NULL,email VARCHAR(50) NOT NULL,nom  VARCHAR(50) NOT NULL,prenom VARCHAR(50) NOT NULL,numeroTelephone VARCHAR(50) NOT NULL,motPasse VARCHAR(200) NOT NULL,compteActif BOOLEAN,dateCreation VARCHAR(50) NOT NULL);
